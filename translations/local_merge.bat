...
r:
cd \code\ryzom\tools\translation

REM cleanup diff directory
del /Y \code\ryzom\tools\translation\bin\.#*.*
del /Y \code\ryzom\tools\translation\diff\*.*
del /Y \code\ryzom\tools\translation\history\*.*
del /Y \code\ryzom\tools\translation\translated\*.*
del /Y \code\ryzom\tools\translation\work\*.*
del /Y \code\ryzom\tools\translation\.#*.*
del /Y \code\ryzom\tools\translation\*.log
